...
""")
  os.system("xdg-open https://t.me/D4RK_NETWORK_99")
  sys.exit()
baner= os.system("figlet -f slant 𝐑𝐗𝐁 𝐉𝐈𝐇𝐀𝐃")
baner = str(baner)
baner = baner.replace("0","")
logo=f""" {baner} \033[1;37m
××××××××××××××××××××××××××××××××××××××××××××
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ DEVELOPER :𝐑𝐗𝐁 𝐉𝐈𝐇𝐀𝐃
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ GITHUB    : RXB-JIH4D
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ VERSION   : 2.0
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ PROJECT   : SMS BOMBING 
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ TELEGRAM  : @RxbJihad0
××××××××××××××××××××××××××××××××××××××××××××"""
print(logo)
print("[01] START SMS BOMBING ")
print("[02] CONTACT ME ON TELEGRAM ")
print("××××××××××××××××××××××××××××××××××××××××××××")
